                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                @endif
                                <div class="mt-3">
                                    <h4>{{ $users[0]->name }} {{ $users[0]->surname }}</h4>
                                    <p class="text-secondary mb-1">{{ $users[0]->info }}</p>
                                    <p class="text-muted font-size-sm">{{ $users[0]->addres }}</p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    {{ $users[0]->name }} {{ $users[0]->surname }} {{ $users[0]->patronymic }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    @if($users[0]->age % 10 === 1)
                                    {{ $users[0]->age }} год
                                    @elseif($users[0]->age % 10 === 0 || $users[0]->age % 10 >= 5 && $users[0]->age % 10 <= 9) {{ $users[0]->age }} лет @elseif($users[0]->age % 10 >= 2 && $users[0]->age % 10 <= 4) {{ $users[0]->age }} года @endif </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
